...
const BUCKETS = {
  ...
  // 月¥3,000 の枠 ÷ 30日 ÷ ¥3.4 ≒ 30回/日 が本来の値。
  //
  // ⚠️ 2026-08-23: **審査の間だけ 30 → 100 に上げている**。
  //    審査担当が試したときに栓に当たると「機能が動かない」と判断されるため。
  //    **1.1 の審査が通ったら 30 に戻すこと**（使い切ると1日¥340・月¥10,000超）。
  // 個人の栓は下の BUCKET_USER_LIMITS で別に切る（回数の桁が parse と違うため）。
  theme:  { min: 6,  day: 40,  globalDay: 100 },   // Claude API（上位モデル）※審査中の暫定値
