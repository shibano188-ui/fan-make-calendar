...
export default function WidgetMonth() {
  ...
  return (
    <div
      className="min-h-screen flex flex-col px-3 pt-4 pb-4"
      style={{
        ...
        <div className="grid grid-cols-7 mb-1">
          {DAY_LABELS.map((label, i) => (
            <div
              ...
              style={{
                color: i === 0 ? 'var(--cal-sunday-color, rgba(239,68,68,0.8))' : i === 6 ? 'var(--cal-saturday-color, rgba(96,165,250,0.8))' : 'var(--cal-weekday-color, var(--label-tertiary))',
              }}
            >
              {label}
            </div>
                ...
                <div
                  ...
                  style={{
                    ...
                    color: isToday
                      ? 'var(--bg-primary)'
                      : !isCurrentMonth
                      ? 'var(--cal-other-month-color, var(--label-tertiary))'
                      : col === 0
                      ? 'var(--cal-sunday-color, rgba(239,68,68,0.8))'
                      : col === 6
                      ? 'var(--cal-saturday-color, rgba(96,165,250,0.8))'
                      : 'var(--cal-weekday-color, var(--label-primary))',
